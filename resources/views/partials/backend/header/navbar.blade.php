        ...
        <a href="/" class="navbar-brand mr-0 mr-md-2 logo">
            <span class="logo-lg">
                ...
                @if (! isset( $settings->site_logo_light ))
                    <span class="d-inline h5 ml-1 text-logo">{{ isset($settings->site_name) ? $settings->site_name : '' }}</span>
                @endif
            </span>
            <span class="logo-sm">
            ...
            <li class="dropdown d-none d-lg-block" data-toggle="tooltip" data-placement="left" title="Change language">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <img src="" alt="user-image" class="mr-2" height="12"> <span
