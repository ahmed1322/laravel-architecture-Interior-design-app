        ...
        <div id="rev_slider_one" class="rev_slider fullscreenbanner" style="display: none;" data-version="5.4.1">
            <ul>
                ...
                <li
                    ...
                    data-thumb="https://via.placeholder.com/1920x950.png"
                    data-rotate="0"
                ...
                >
                    ...
                    <div
                        class="tp-caption tp-resizeme tp-caption-big"
                        id="{{ 'slide-7'.$slider->id.'-layer-1' }}"
                    ...
                    <!-- LAYER 4  Bold Title-->
                    <div
                        class="tp-caption tp-resizeme tp-caption-main"
                        id="{{ 'slide-7'.$slider->id.'-layer-2' }}"
                        data-x="['center','center','center','center']"
                    ...
                    <!-- LAYER 5  Paragraph-->
                    <div
                        class="tp-caption tp-resizeme tp-desc"
                        id="{{ 'slide-7'.$slider->id.'-layer-3' }}"
                        data-x="['center','center','center','center']"
                    ...
                    >
                        <a href="{{ route( 'portfolio.single', [ 'portfolio' => $slider->portfolio->id, 'slug' => $slider->portfolio->slug ] )  }}" class="octf-btn octf-btn-primary btn-slider btn-large">View Projects</a>
                    </div>
                </li>
                @empty
