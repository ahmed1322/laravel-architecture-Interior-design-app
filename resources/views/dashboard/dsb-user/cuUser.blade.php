                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active show p-3" id="posts" role="tabpanel" aria-labelledby="posts">
                                <div class="custom-control custom-switch mb-2">
                                    <input type="checkbox" @isset($role->post_roles['c']) checked @endisset name="post_roles[c]" value="1" class="custom-control-input" id="create_post">
                                    <label class="custom-control-label" for="create_post">Allow Create Posts</label>
                                </div>
                                <div class="custom-control custom-switch mb-2">
                                    <input type="checkbox" @isset($role->post_roles['r']) checked @endisset name="post_roles[r]" value="1" class="custom-control-input" id="read_post">
                                    <label class="custom-control-label" for="read_post">Allow Read Posts</label>
                                </div>
                                <div class="custom-control custom-switch mb-2">
                                    <input type="checkbox" @isset($role->post_roles['u']) checked @endisset name="post_roles[u]" value="1" class="custom-control-input" id="update_post">
                                    <label class="custom-control-label" for="update_post">Allow Update Posts</label>
                                </div>
                                <div class="custom-control custom-switch mb-2">
                                    <input type="checkbox" @isset($role->post_roles['d']) checked @endisset name="post_roles[d]" value="1" class="custom-control-input" id="delete_post">
                            ...
                            <div class="tab-pane fade p-3" id="categories" role="tabpanel" aria-labelledby="categories">
                                <div class="custom-control custom-switch mb-2">
                                    <input type="checkbox" @isset($role->category_roles['c']) checked @endisset name="category_roles[c]" value="0" class="custom-control-input" id="create_category">
                                    <label class="custom-control-label" for="create_category">Allow Create categories</label>
                                </div>
                                <div class="custom-control custom-switch mb-2">
                                    <input type="checkbox" @isset($role->category_roles['r']) checked @endisset name="category_roles[r]" value="0" class="custom-control-input" id="read_category">
                                    <label class="custom-control-label" for="read_category">Allow Read categories</label>
                                </div>
                                <div class="custom-control custom-switch mb-2">
                                    <input type="checkbox" @isset($role->category_roles['u']) checked @endisset name="category_roles[u]" value="0" class="custom-control-input" id="update_category">
                                    <label class="custom-control-label" for="update_category">Allow Update categories</label>
                                </div>
                                <div class="custom-control custom-switch mb-2">
                                    <input type="checkbox" @isset($role->category_roles['d']) checked @endisset name="category_roles[d]" value="0" class="custom-control-input" id="delete_category">
                            ...
                            <div class="tab-pane fade p-3" id="tags" role="tabpanel" aria-labelledby="tags">
                                <div class="custom-control custom-switch mb-2">
                                    <input type="checkbox" @isset($role->tag_roles['c']) checked @endisset name="tag_roles[c]" value="0" class="custom-control-input" id="create_tag">
                                    <label class="custom-control-label" for="create_tag">Allow Create Tags</label>
                                </div>
                                <div class="custom-control custom-switch mb-2">
                                    <input type="checkbox" @isset($role->tag_roles['r']) checked @endisset name="tag_roles[r]" value="0" class="custom-control-input" id="read_tag">
                                    <label class="custom-control-label" for="read_tag">Allow Read Tags</label>
                                </div>
                                <div class="custom-control custom-switch mb-2">
                                    <input type="checkbox" @isset($role->tag_roles['u']) checked @endisset name="tag_roles[u]" value="0" class="custom-control-input" id="update_tag">
                                    <label class="custom-control-label" for="update_tag">Allow Update Tags</label>
                                </div>
                                <div class="custom-control custom-switch mb-2">
                                    <input type="checkbox" @isset($role->tag_roles['d']) checked @endisset name="tag_roles[d]" value="0" class="custom-control-input" id="delete_tag">
